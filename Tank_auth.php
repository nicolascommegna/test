...
class Tank_auth
{
	...
	function get_user_role()
	{
			...
			return $this->ci->users->get_user_by_id($user_id, TRUE)->user_role;
	}
	...
	function get_user_permission()
	{
		...
		$user_permissions = $CI->sharedDB_model->get('user_roles', array('methods'), array('id' => $this->get_user_role()));
		$user_permissions = $user_permissions[0]['methods'];
		if(isset($user_permissions) && (strlen($user_permissions) > 0))
			return get_object_vars(json_decode($user_permissions));
	}
