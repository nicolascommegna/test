<section class="span12">
	...
	<div class="content">
		...
		foreach ( $allVehicleData as $vehicle ) {
			?>
		<strong>
			<?php echo $vehicle[0]['vehicle']['name']; ?>
		</strong>
		<div>
			<?php echo $vehicle[0]['vehicle']['vehicle_number']; ?>
		</div>
		<div>
			<?php echo $vehicle[0]['vehicle']['fuel_capacity']; ?> litres</div>
		<br>
			...
			<tbody>
				...
				<tr>
					...
					<td style='text-align: right;'>
						<?php echo $data['odometer_reading']; ?> <em>km</em>
					</td>
					<td style='text-align: right;'>
						<?php echo $distance; ?> <em>km</em>
					</td>
					<td style='text-align: right;'>
						<?php  
						$fpart=$data['fuel_amount'];
						$str=<<<HTML
						<div style='font-size: 12px;'>(Refueled Amount)</div>
HTML;
						$str1=<<<HTML
							<em>l</em>
HTML;
					...
					<td style='text-align: right;'>
						<?php echo $data['date_nepali']['date'] . ' ' . $data['date_nepali']['nmonth'] . ', ' . $data['date_nepali']['year']; ?>
					</td>
					<td style='text-align: center;'>
						<?php echo $data['added_on']; ?>
					</td>
					<td style='text-align: right;'>
						<?php echo $data['added_on_nepali']['date'] . ' ' . $data['added_on_nepali']['nmonth'] . ', ' . $data['added_on_nepali']['year']; ?>
					</td>
				</tr>
				<?php
				$j++;
